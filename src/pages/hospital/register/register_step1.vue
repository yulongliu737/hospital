...
const getDoctorWorkData = async() => {
  ...
  let doctorResult:DoctorResponseData = await reqDocInfo(hoscode, depcode, workTime.value.workDate)
  // console.log(JSON.stringify(doctorResult))
  if (doctorResult.code === 200) {
    docArr.value = doctorResult.data
  }
}
